...
void I2Ccommand(int recvflag)     
{
  ...
  {
    Serial.println("error flag was set");
  ...
  else
  {
    errorflag = errorflag | 2;                                                 // incorrect pwmfreq given
      ...
      Serial.println("pwm frequency: " + b);
  ...
  Serial.println("left motor speed: " + i);
  lmbrake=Wire.read();  // read new left  motor brake status
  Serial.println("left brake: " + lmbrake);
  ...
  Serial.println("right motor speed: " + i);
  rmbrake=Wire.read();                                                         // read new right motor brake status
    Serial.println("right brake: " + rmbrake);
